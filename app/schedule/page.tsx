      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <section>
            ...
            <div
              className="rounded-2xl border-2 border-dashed border-gray-200 bg-white flex flex-col items-center justify-center py-16 px-8 text-center gap-3"
              style={{ minHeight: "400px" }}
            >
              <CalendarDays size={40} className="text-gray-200" />
              <p className="text-gray-400 text-sm font-medium">구글 캘린더 연동 예정</p>
              <p className="text-gray-300 text-xs leading-relaxed">
                추후 Google Calendar API를 연동하여<br />
                동아리 일정을 여기에 표시할 예정입니다.
              </p>
              <a
